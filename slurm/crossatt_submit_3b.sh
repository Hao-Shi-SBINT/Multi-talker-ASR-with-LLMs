...
ins=false
pmp=exp_ctc_finished/mode_ctc-wavlm-Llama-3.2-3B-encoder_freeze-decoder_freeze-adater_encoder_decoder-ctc-libri2mix_noisy
sbatch \
...
ins=true
pmp=exp_ctc_finished/mode_ctc-wavlm-Llama-3.2-3B-Instruct-encoder_freeze-decoder_freeze-adater_encoder_decoder-ctc-libri2mix_noisy
sbatch \
  ${EXCLUDE_NODES:+--exclude="${EXCLUDE_NODES// /}"} \
  --job-name="${dec}-${corp}-${ins}" \
  template.slurm \
...
ins=false
pmp=exp_ctc_finished/mode_ctc-wavlm-Llama-3.2-3B-encoder_freeze-decoder_freeze-adater_encoder_decoder-ctc-libri2mix_clean
sbatch \
  ${EXCLUDE_NODES:+--exclude="${EXCLUDE_NODES// /}"} \
  --job-name="${dec}-${corp}-${ins}" \
  template.slurm \
...
dec=Llama-3.2-3B-Instruct
ins=true
pmp=exp_ctc_finished/mode_ctc-wavlm-Llama-3.2-3B-Instruct-encoder_freeze-decoder_freeze-adater_encoder_decoder-ctc-libri2mix_clean
sbatch \
  ${EXCLUDE_NODES:+--exclude="${EXCLUDE_NODES// /}"} \
  --job-name="${dec}-${corp}-${ins}" \
  template.slurm \
...
ins=false
pmp=exp_ctc_finished/mode_ctc-wavlm-Llama-3.2-3B-encoder_freeze-decoder_freeze-adater_encoder_decoder-ctc-libri3mix_noisy
sbatch \
  ${EXCLUDE_NODES:+--exclude="${EXCLUDE_NODES// /}"} \
  --job-name="${dec}-${corp}-${ins}" \
  template.slurm \
...
dec=Llama-3.2-3B-Instruct
ins=true
pmp=exp_ctc_finished/mode_ctc-wavlm-Llama-3.2-3B-Instruct-encoder_freeze-decoder_freeze-adater_encoder_decoder-ctc-libri3mix_noisy
sbatch \
  ${EXCLUDE_NODES:+--exclude="${EXCLUDE_NODES// /}"} \
  --job-name="${dec}-${corp}-${ins}" \
  template.slurm \
...
ins=false
pmp=exp_ctc_finished/mode_ctc-wavlm-Llama-3.2-3B-encoder_freeze-decoder_freeze-adater_encoder_decoder-ctc-libri3mix_clean
sbatch \
  ${EXCLUDE_NODES:+--exclude="${EXCLUDE_NODES// /}"} \
  --job-name="${dec}-${corp}-${ins}" \
  template.slurm \
...
dec=Llama-3.2-3B-Instruct
ins=true
pmp=exp_ctc_finished/mode_ctc-wavlm-Llama-3.2-3B-Instruct-encoder_freeze-decoder_freeze-adater_encoder_decoder-ctc-libri3mix_clean
sbatch \
  ${EXCLUDE_NODES:+--exclude="${EXCLUDE_NODES// /}"} \
  --job-name="${dec}-${corp}-${ins}" \
  template.slurm \
